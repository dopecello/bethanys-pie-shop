using PieShop.InventoryMgmt.Domain.OrderMgmt;
...
namespace PieShop.InventoryMgmt
{
    internal class Utilities
    {
        ...
        internal static void InitializeStock()//Mock implementation
        {
            ...
            inventory = productRepo.LoadProductsFromFile();
        ...
        {
            UnitType unitType = UnitType.PerItem; //this is default.
            ...
            {
                ShowAllUnitTypes();
                Console.Write("Select a unit type: ");
            ...
            int newId = inventory.Max(p => p.Id) + 1; //finds highest id and increases with 1.
        ...
        private static void ShowAllUnitCurrencies()
        {
            int i = 1;
